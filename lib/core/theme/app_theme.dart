...
// Paleta central de la app. El Dark Theme es exactamente la paleta que ya
// existía hardcodeada en las screens (navy 1A1A2E/16213E/0F3460 + acento
// coral E94560). El Light Theme es una paleta nueva, diseñada para
// mantener la misma relación tonal (fondo frío azul/índigo, mismo acento
// de marca, mismo verde/ámbar semánticos) pero invertida en luminosidad.
class AppTheme {
  AppTheme._();
